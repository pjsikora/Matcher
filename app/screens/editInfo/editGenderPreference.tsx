...
interface EditGenderPreferenceProps {
  navigation: any;
}
const EditGenderPreference = ({ navigation }: EditGenderPreferenceProps) => {
    ...
    <View style={styles.allContains}>
      ...
      <View style={styles.container}>
        <View style={styles.buttonsContainer}>
          ...
          >
            <View style={styles.circle}>
              {gender === "Both" && <View style={styles.circleFill}></View>}
            </View>
            <Text
              style={{
                fontSize: 20,
...
export default EditGenderPreference;
